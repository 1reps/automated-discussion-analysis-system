...
class MediaProcessingServiceTest {
  ...
  @Autowired private MediaProcessingService service;

  @Autowired private RecordingRepository recordingRepository;
  @Autowired private TranscriptSegmentRepository transcriptRepository;
  @Autowired private DiarizationSegmentRepository diarRepository;
  @Autowired private SpeakerTurnRepository turnRepository;

  @MockBean private SttClient sttClient;
  @MockBean private DiarizationClient diarClient;
  @MockBean private MediaProbeService mediaProbeService;
